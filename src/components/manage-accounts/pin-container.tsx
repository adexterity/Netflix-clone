...
export default function PinContainer({
    ...
    <div className="z-[100] bg-[#141414] flex-col  min-h-screen absolute left-0 top-0 justify-center flex items-center right-0">
        ...
        <PinInput length={4} initialValue={pin} secret secretDelay={100} onChange={(value, index)=> setPin(value)} type="numeric" inputMode='number' style={{padding: '20px', display: 'flex', gap: '10px'}}inputStyle={{
            borderColor: 'white', height: '70px', width: '70px', fontSize: '40px'
        }}
